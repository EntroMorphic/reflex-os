 ...
 * the 12738-node SVD manifest). This helper stores the low byte of the
...
/**
 * @brief Entry in the 12738-node shadow catalog generated by
...
/** @brief The shadow catalog itself — 12738 entries, sorted by name. */
