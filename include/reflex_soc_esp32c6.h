...
/* EXTMEM.L1_CACHE_AUTOLOAD_CTRL @ base+0x134 */
#define REFLEX_EXTMEM_L1_CACHE_AUTOLOAD_CTRL_REG 0x600C8134u
/* EXTMEM.L1_CACHE_AUTOLOAD_CTRL.L1_CACHE_AUTOLOAD_ENA bit 0 — cache autoload enable */
...
/* SPI1.SPI_MEM_CMD @ base+0x0 — command bits; a started command self-clears */
#define REFLEX_SPI1_CMD_REG 0x60003000u
/* SPI1.SPI_MEM_ADDR @ base+0x4 — flash address for the next command */
#define REFLEX_SPI1_ADDR_REG 0x60003004u
/* SPI1.SPI_MEM_CTRL @ base+0x8 — line mode; zero is plain single-line */
#define REFLEX_SPI1_CTRL_REG 0x60003008u
/* SPI1.SPI_MEM_USER @ base+0x18 — which phases a user transaction has */
#define REFLEX_SPI1_USER_REG 0x60003018u
/* SPI1.SPI_MEM_USER1 @ base+0x1C — address and dummy phase lengths */
#define REFLEX_SPI1_USER1_REG 0x6000301Cu
/* SPI1.SPI_MEM_USER2 @ base+0x20 — command value and its bit length */
#define REFLEX_SPI1_USER2_REG 0x60003020u
/* SPI1.SPI_MEM_MOSI_DLEN @ base+0x24 */
#define REFLEX_SPI1_MOSI_DLEN_REG 0x60003024u
/* SPI1.SPI_MEM_MISO_DLEN @ base+0x28 */
#define REFLEX_SPI1_MISO_DLEN_REG 0x60003028u
/* SPI1.SPI_MEM_RD_STATUS @ base+0x2C — flash status register after FLASH_RDSR */
#define REFLEX_SPI1_RD_STATUS_REG 0x6000302Cu
/* SPI1.SPI_MEM_W0 @ base+0x58 — first of 16 data words: 64 bytes per transaction */
#define REFLEX_SPI1_W0_REG 0x60003058u
/* SPI1.SPI_MEM_CMD.SPI_MEM_USR bit 18 — start a user-defined transaction */
#define REFLEX_SPI1_CMD_USR 0x00040000u
/* SPI1.SPI_MEM_CMD.SPI_MEM_FLASH_READ bit 31 */
#define REFLEX_SPI1_CMD_FLASH_READ 0x80000000u
/* SPI1.SPI_MEM_CMD.SPI_MEM_FLASH_WREN bit 30 — write enable, required before program and erase */
#define REFLEX_SPI1_CMD_FLASH_WREN 0x40000000u
/* SPI1.SPI_MEM_CMD.SPI_MEM_FLASH_RDSR bit 27 — read status; bit 0 of RD_STATUS is write-in-progress
 */
#define REFLEX_SPI1_CMD_FLASH_RDSR 0x08000000u
/* SPI1.SPI_MEM_CMD.SPI_MEM_FLASH_SE bit 24 — sector erase at ADDR */
#define REFLEX_SPI1_CMD_FLASH_SE 0x01000000u
/* SPI1.SPI_MEM_CMD.SPI_MEM_FLASH_PP bit 25 — page program at ADDR from the data words */
#define REFLEX_SPI1_CMD_FLASH_PP 0x02000000u
/* SPI1.SPI_MEM_USER.SPI_MEM_USR_COMMAND bit 31 */
#define REFLEX_SPI1_USR_COMMAND 0x80000000u
/* SPI1.SPI_MEM_USER.SPI_MEM_USR_ADDR bit 30 */
#define REFLEX_SPI1_USR_ADDR 0x40000000u
/* SPI1.SPI_MEM_USER.SPI_MEM_USR_DUMMY bit 29 */
#define REFLEX_SPI1_USR_DUMMY 0x20000000u
/* SPI1.SPI_MEM_USER.SPI_MEM_USR_MISO bit 28 */
#define REFLEX_SPI1_USR_MISO 0x10000000u
/* SPI1.SPI_MEM_USER.SPI_MEM_USR_MOSI bit 27 */
#define REFLEX_SPI1_USR_MOSI 0x08000000u
...
/* SPI1.SPI_MEM_USER1.SPI_MEM_USR_ADDR_BITLEN width 6 — field value mask */
#define REFLEX_SPI1_USR_ADDR_BITLEN_V 0x0000003Fu
/* SPI1.SPI_MEM_USER1.SPI_MEM_USR_DUMMY_CYCLELEN width 6 — field value mask */
#define REFLEX_SPI1_USR_DUMMY_CYCLELEN_V 0x0000003Fu
/* SPI1.SPI_MEM_USER2.SPI_MEM_USR_COMMAND_VALUE width 16 — field value mask */
#define REFLEX_SPI1_USR_COMMAND_VALUE_V 0x0000FFFFu
/* SPI1.SPI_MEM_USER2.SPI_MEM_USR_COMMAND_BITLEN width 4 — field value mask */
#define REFLEX_SPI1_USR_COMMAND_BITLEN_V 0x0000000Fu
/* SPI1.SPI_MEM_MISO_DLEN.SPI_MEM_USR_MISO_DBITLEN width 10 — field value mask */
#define REFLEX_SPI1_USR_MISO_DBITLEN_V 0x000003FFu
/* SPI1.SPI_MEM_MOSI_DLEN.SPI_MEM_USR_MOSI_DBITLEN width 10 — field value mask */
#define REFLEX_SPI1_USR_MOSI_DBITLEN_V 0x000003FFu
...
/* SPI1.SPI_MEM_USER1.SPI_MEM_USR_ADDR_BITLEN bit 26 — field shift */
#define REFLEX_SPI1_USR_ADDR_BITLEN_S 0x0000001Au
/* SPI1.SPI_MEM_USER1.SPI_MEM_USR_DUMMY_CYCLELEN bit 0 — field shift */
#define REFLEX_SPI1_USR_DUMMY_CYCLELEN_S 0x00000000u
/* SPI1.SPI_MEM_USER2.SPI_MEM_USR_COMMAND_VALUE bit 0 — field shift */
#define REFLEX_SPI1_USR_COMMAND_VALUE_S 0x00000000u
/* SPI1.SPI_MEM_USER2.SPI_MEM_USR_COMMAND_BITLEN bit 28 — field shift */
#define REFLEX_SPI1_USR_COMMAND_BITLEN_S 0x0000001Cu
/* SPI1.SPI_MEM_MISO_DLEN.SPI_MEM_USR_MISO_DBITLEN bit 0 — field shift */
#define REFLEX_SPI1_USR_MISO_DBITLEN_S 0x00000000u
/* SPI1.SPI_MEM_MOSI_DLEN.SPI_MEM_USR_MOSI_DBITLEN bit 0 — field shift */
#define REFLEX_SPI1_USR_MOSI_DBITLEN_S 0x00000000u
